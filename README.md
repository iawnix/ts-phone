...
Mobile version 0.9.0 distinguishes live, observer, recovery, history-only, and
...
`0.9.0+28`, API v3, Events v3, Bridge v2, the server entry, APK, source commit,
...
API v3-compatible 0.9.0 mobile client. API v3 and Bridge v2 remain intentional
