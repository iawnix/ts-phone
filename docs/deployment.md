...
validates bounded Root Agent runtime snapshots. Mobile version 0.10.0 displays
...
| Mobile app | 0.10.0+32 | API v3, zh/en UI, session details, timeline branches and activity rail |
