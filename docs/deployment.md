...
validates bounded Root Agent runtime snapshots. Mobile version 0.10.1 displays
...
| Mobile app | 0.10.1+33 | API v3, zh/en UI, session details, timeline branches and activity rail |
