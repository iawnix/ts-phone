...
validates bounded Root Agent runtime snapshots. Mobile version 0.11.0 displays
...
| Mobile app | 0.11.0+34 | API v3, zh/en UI, session details, timeline branches and activity rail |
